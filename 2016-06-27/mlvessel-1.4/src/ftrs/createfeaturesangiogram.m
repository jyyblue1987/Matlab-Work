function createfeaturesangiogram(img, scales, paderosionsize, outputfilename)
% createfeaturesangiogram(img, scales, paderosionsize, outputfilename) 
%
% Recieves a gray-scale fluorescein angiogram, generates and writes
% each pixel's features on file named "outputfilename". "scales" is a
...
[description, features] = generatefeaturesangiogram(img, mask, scales, ...
                                                    paderosionsize);
