function createfeaturesredfree(img, scales, paderosionsize, outputfilename)
% createfeaturesredfree(img, scales, paderosionsize, outputfilename) 
%
% Recieves a gray-scale red-free image, generates and writes each
