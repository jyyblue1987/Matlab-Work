function mask = createlabelled(featurefilename, segmentationfilename,...
                               outputfilename, roisize)
% mask = createlabelled(featurefilename, segmentationfilename,...
%                       outputfilename, roisize)
%
...
class = imread(segmentationfilename);
...
save(outputfilename, 'description', 'featurematrix', 'mask', '-MAT');
