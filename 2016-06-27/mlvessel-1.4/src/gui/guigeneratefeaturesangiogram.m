function [features, mask] = guigeneratefeaturesangiogram(img, featurestype)
% [features, mask] = guigeneratefeaturesangiogram(image, imagetype, featurestype)
%
% Recieves a gray-scale fluorescein angiogram image, and a cell of
% structs defining the features to be created (featurestype). The
% features are generated and returned in a cell of structs
% "features". The function also return the mask defining the image's
% region of interest.
%
...
for i=1:length(features)
    switch features{i}.type
        case 'Gray channel'
            ...
            features{i}.name = 'Gray channel';
            features{i}.shortname = 'gray';
        case 'Gabor processed gray channel'
            k0x = 0;
            ...
            features{i}.name = ['Gabor processed gray channel: a = ' ...
