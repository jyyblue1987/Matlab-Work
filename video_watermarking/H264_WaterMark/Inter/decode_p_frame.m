...
global mvm S h w 
global GetWaterMark BlockForEncode frame_id
...
%             disp('Decoding 16x16 MB')
        ...
        switch mode
            case 0
                ...
                if block_id==BlockForEncode
                    if frame_id<=length(GetWaterMark)
                        if mvx < 0 watervalue = 1;
                        else watervalue = 0;
                        end
                        GetWaterMark(frame_id) = watervalue;
                    end
                end
